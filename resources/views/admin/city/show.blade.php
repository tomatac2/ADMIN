        ...
        <div class="container mt-4">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">{{ __("static.city_details") }} : {{ $city->name }}</h4>
                    
                    <a href="{{ route('admin.cities.edit', $city->id) }}" class="btn btn-warning text-white">
...
<div class="card-body">
                    ...
                    <h5 class="mt-4"> {{ __("static.state_cities") }} ({{ $city->state->name }})</h5>
