...
Route::group(['middleware' => ['localization']], function () {
    ...
    Route::group(['middleware' => ['auth'], 'namespace' => 'Admin', 'as' => 'admin.'], function () {
        ...
        Route::get('role/force-delete/{id}', 'RoleController@forceDelete')->name('role.forceDelete')->middleware('can:role.destroy');
        ...
        Route::get('faq-category/destroy/{faqCategory}', 'FaqCategoryController@destroy')->name('faq-category.destroy')->middleware('can:faq.destroy');
        Route::get('faq-category/restore/{id}', 'FaqCategoryController@restore')->name('faq-category.restore')->middleware('can:faq.restore');
        Route::get('faq-category/force-delete/{id}', 'FaqCategoryController@forceDelete')->name('faq-category.forceDelete')->middleware('can:faq.forceDelete');
